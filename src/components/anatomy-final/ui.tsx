...
export default function AnatomyExplorer(){
 ...
 return <div className="anatomy-final">
  <header className="af-header"><Link className="af-brand" href="/" aria-label="Medica home"><Image className="af-brand-logo" src="/Medica-logo.png" alt="Medica" width={115} height={35} unoptimized/><span className="af-brand-divider"/><span className="af-product">Anatomy atlas</span></Link><Link href="/anatomy" className="af-back" aria-label="Organ library"><Icon kind="arrow"/><span>Organ library</span></Link></header>
